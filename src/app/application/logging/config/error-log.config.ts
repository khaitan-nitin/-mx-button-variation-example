...
export const errorLogCrud: Crud = {
    identifier: "errorLogCrud",
    header: {
        title: "Log",
        description: { 
            text: 'Error log provide insite into the api that got failed in invocation'
        },
        searchModeTitle: "Search Error Log",
        viewModeTitle: "Error Log"
    },
    actions: [
    ],
    quickLinks: [
    ...
    search: {
        ...
        form: {
            identifier: "errorLogSearchForm",
            header: {
                title: "Search Error Log",
            },
            description: {
                text: "Filter criteria based on which error logs can be searched"
            },
            displayInColumns: 3,
            formFields: [
                {
    ...
    list: {
        ...
        lists: [
            {
                identifier: "errorLogList",
                header: {
                    title: "List of Error Logs"
                },
                columns: [
                    {
                        fields: [
    ...
    form: {
        ...
        tabs: [
            {
                identifier: "errorLogForms",
                label: "Error Log",
                description: {
                    text: ""
                },
                statistic: "10",
                displayOnAction: "errorLog",
