...
@Component({
  ...
  templateUrl: './html-editor-example.component.html',
  styleUrls: ['./html-editor-example.component.scss']
})
export class HtmlEditorExampleComponent extends CrudListComponentInterface implements OnInit {
