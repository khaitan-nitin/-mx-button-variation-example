...
@Component({
  selector: 'app-paragraph-example',
  templateUrl: './paragraph-example.component.html',
  styleUrls: ['./paragraph-example.component.scss']
})
export class ParagraphExampleComponent extends CrudListComponentInterface implements OnInit {
