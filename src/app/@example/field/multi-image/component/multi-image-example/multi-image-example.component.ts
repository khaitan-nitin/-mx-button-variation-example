...
@Component({
  selector: 'app-multi-image-example',
  templateUrl: './multi-image-example.component.html',
  styleUrls: ['./multi-image-example.component.scss']
})
export class MultiImageExampleComponent extends CrudListComponentInterface implements OnInit {
